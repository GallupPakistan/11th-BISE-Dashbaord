...
from common import (
    ...
    load_workbook, show_missing_workbook_error, gender_df_for,
    kpi_card, style_fig, show_chart, fmt_k, csv_download_button,
    grouped_bar_chart, gender_split_pie, GENDER_COLORS, NAVY, TEAL,
    BOARD_PROVINCE, ALL_BOARD_NAMES,
)
...
with col1:
    ...
    fig = gender_split_pie(overall, "Overall Appeared Share")
    show_chart(fig)
